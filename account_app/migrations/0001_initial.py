# Generated by Django 4.2.17 on 2024-12-16 04:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'SuperAdmin'), (2, 'Admin'), (3, 'Guest'), (4, 'QA')], default=1)),
                ...
                ('instancy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account_app.instancy')),
